...
void UStartWidget::NativeConstruct()
{
	...
	m_StartButton = Cast<UButton>(GetWidgetFromName(TEXT("Start")));
	m_ExitButton = Cast<UButton>(GetWidgetFromName(TEXT("End")));

	m_StartButton->OnClicked.AddDynamic(this, &UStartWidget::StartButtonClick);
	m_StartButton->OnHovered.AddDynamic(this, &UStartWidget::StartButtonHovered);
	m_StartButton->OnUnhovered.AddDynamic(this, &UStartWidget::StartButtonUnHovered);

	m_ExitButton->OnClicked.AddDynamic(this, &UStartWidget::ExitButtonClick);
	m_ExitButton->OnHovered.AddDynamic(this, &UStartWidget::ExitButtonHovered);
	m_ExitButton->OnUnhovered.AddDynamic(this, &UStartWidget::ExitButtonUnHovered);
}
...
{
	bool Reply = Super::NativeOnDragOver(InGeometry, InDragDropEvent, InOperation);
...
{
	bool Reply = Super::NativeOnDrop(InGeometry, InDragDropEvent, InOperation);
...
{
	FReply Reply = Super::NativeOnTouchGesture(InGeometry, InGestureEvent);
...
{
	FReply Reply = Super::NativeOnMotionDetected(InGeometry, InMotionEvent);
...
{
	FReply Reply = Super::NativeOnTouchForceChanged(MyGeometry, TouchEvent);
